...
if debugging:
    ...
    gray = Gradients.gray_tresh(image, thresh=(150, 240))
    gradx = Gradients.abs_sobel_thresh(image, orient='x', sobel_kernel=ksize, thresh=(20, 100))
    grady = Gradients.abs_sobel_thresh(image, orient='y', sobel_kernel=ksize, thresh=(20, 100))
    mag_binary = Gradients.mag_thresh(image, sobel_kernel=ksize, mag_thresh=(30, 100))
    dir_binary = Gradients.dir_threshold(image, sobel_kernel=15, thresh=(0.2, 1))
    hls_binary = Gradients.hls_select(image, thresh=(90, 255))
    l_xgrad = Gradients.hls_l_xgrad(image, sobel_kernel=5, thresh=(20, 100))



    combined1 = np.zeros_like(dir_binary)
    combined1=hls_binary | l_xgrad == 1
